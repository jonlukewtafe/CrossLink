...
return [
    ...
    /**
     * The database connection to use for the Tag1 model and associated tables.
     ...
     *
     *  $posts = Tag1::findByName('Apple')->posts;
     *
     ...
     * create your own class that extends the package's Tag1 model,
