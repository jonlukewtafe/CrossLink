...
@section ('title' , 'CrossLink - Edit Bookmark')
...
@section('content')
    ...
    <div class="grid-x grid-padding-x">
        ...
        @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('bookmarks.update', $bookmark->id) }}" class="callout small-12 medium-12 large-12" name="EditStop">
            @method('PATCH')
            @csrf
